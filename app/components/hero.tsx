...
const HeroSection = () => {
  return (
    <section>
      <div className="relative h-[60vh] sm:h-[600px] w-full flex items-end justify-center bg-cover bg-center sm:bg-[center_top_25%] bg-no-repeat bg-[url('https://ik.imagekit.io/gsozk5bngn/Wedding/Marquee/SHO07023_5YZY9XwCOH.jpg?updatedAt=1735456327972')]">
        ...
        <div className="z-20 w-fit h-fit overflow-hidden text-center py-8">
          ...
          <h2
            className={`${greatVibes.className} text-base sm:text-3xl text-white p-3 `}
          >
